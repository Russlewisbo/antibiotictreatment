...
## Principles of Antibiotic Therapy {background-color="#9B0014"}
...
![](resistance.jpg){fig-align="center" width="800"}
...
## Current antibiotic resistance statistics {.smaller}
...
## World Health Organization (WHO) <br> Pathogen Priority List {.smaller}

![](images/WHO.png){fig-align="center" width="500"}
...
# Principle #1: Develop an accurate <br> differential diagnosis {background-color="#9B0014"}
...
## Medical history is 80% of diagnosis in <br> infectious diseases {.smaller}
...
![](images/brucellosis.png){fig-align="center"} Zoonotic Gram-negative coccobacilli

::: footer
[@massis2005]
:::

## Diagnosis and treatment of <br>Brucellosis spondylitis: <br>

<center>*Specialized diagnostics and therapy!*</center>
...
![](images/URI.png){fig-align="center" width="400"}

<center>Clinicians frequently *overestimate* the risk of bacterial infection</center>
...
![](images/adverseeffects.png){fig-align="center" width="600"}
...
-   Without symptoms, a positive culture often represents **colonization or contamination** **and should not necessarily trigger treatment** <br> <br> <br>
...
![](images/computer.png){fig-align="center" width="400"}

::: footer
[@luu2021]
:::

## Simple stewardship intervention {.smaller}

![](images/outcomes.png){fig-align="center" width="400"}

::: footer
[@luu2021]
:::

# Principle #2: Only use antibiotics when they alter the clinical course of patients {background-color="#9B0014"}
...
![](images/osteo.png){fig-align="center" width="200"}
:::
:::::

## Ethical dilemmas for use of <br>antimicrobial therapy
...
## Principle #3: Empirically target microbes in differential diagnosis {background-color="#9B0014"}
...
<br> <br> *Special circumstances creates exceptions: For example, community-acquired pneumonia and intraabdominal, skin, and urinary infections may be caused by Pseudomonas in patients with cystic fibrosis or with history of bronchiectasis, chronic dialysis patient, or patient with indwelling catheters or recent surgery.*

# Principle #4: There is a lower threshold for empirical therapy in critically-ill patients {background-color="#9B0014"}
...
## Principle #5: Host factors affect the spectrum of empirical therapy {.smaller}

![](images/immunocompromise.png){fig-align="center"}


## Common immunocompromised conditions {.smaller}
...
## Community acquired pneumonia (CAP) <br> vs. Pneumocystis jirovecii pneumonia (PCP)
...
## Principle #6: Use PK/PD principles to optimize <br> treatment selection and dosing
...
![](images/clipboard-2574271174.png){fig-align="center" width="600"}

::: aside
[@gilbert2006a]
:::

## Second key pharmacokinetic variable: <br> Clearance (CL)
...
## Important distinctions between <br> Vd and CL in antibiotic dosing
...
## Most antibiotics are eliminated via the kidneys and maintenance doses must be adjusted for renal function {.smaller}
...
<center>https://www.uptodate.com/contents/search <br> [UptoDate](https://www.uptodate.com/contents/search)</center>

## PK/PD indices

![](images/clipboard-2657724390.png){fig-align="center" width="800"}
...
## PK/PD characteristics of common <br> antibiotic classes
...
## Choosing therapy : <br> gram-stain vs. guidelines {.smaller}

![](images/grace_trial.png){fig-align="center" width="800"}
...
-   Consider changing antibiotics of the following parameters do not improve: <br> <br>
...
# Common myths of antibiotic therapy {background-color="#9B0014"}

## Myth 1:<br> "Bactericidal" antibiotics are more effective <br> than "bacteriostatic" {.smaller}
...
## Systematic literature reviews: *cidal vs. static* <br> antibiotics for bacterial infections\*
...
## Myth 2: Oral antibioic therapy is less effective <br> than IV for complex infections
...
## Transitioning to oral therapy: <br> Key considerations
...
## Exotoxin-mediated infections- <br> Necrotizing fasciitis
...
## Eukaryotic infections: <br> Combination therapy is beneficial
...
## Combination therapy for  <br>*Pseudomonas aeruginosa*

![](images/psa_meta.png){fig-align="center" width="800"}
