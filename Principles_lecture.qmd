...
======= +------------------------------+--------------------+----------------+--------------+ \| Disease \| Pre-antibiotic era \| Antibiotic era \| Change \| +==============================+====================+================+==============+ \| Community-acquired pneumonia \| \~ 35% \| \~ 10% \| -25% \| +------------------------------+--------------------+----------------+--------------+ \| Nosocomial pneumonia \| \~ 60% \| \~ 30% \| -30% \| +------------------------------+--------------------+----------------+--------------+ \| Bacterial endocarditis \| \~ 100% \| \~ 25% \| -75% \| +------------------------------+--------------------+----------------+--------------+ \| Gram-negative bacteremia \| \~ 70% \| \~ 10% \| -60% \| +------------------------------+--------------------+----------------+--------------+ \| Bacterial meningitis \| \> 80% \| \< 20% \| -60% \| +------------------------------+--------------------+----------------+--------------+ \| Skin infection o \| \~ 11% \| \< 0.5% \| -10% \| +------------------------------+--------------------+----------------+--------------+
...
## Medical history in infectious diseases
...
-   **Spondylitis etiologies:** 
    ...
    -   \~ 25% *Streptococcus* spp., *Enterococcus* spp. *Pseudomonas aeruginosa,* E*nterobacter* spp., *Proteus spp. E. coli, Serratia spp.,* Anaerobes, *Mycobacterium tuberculosis (Pott’s disease)*
:::
...
-   De-escalation with pathogen identification -e.g., stopping empirical vancomycin in patient with Gram-negative bacilli in blood cultures

-   Improvement in fever and leukocytosis

-   Empiric de-escalation of therapies for highly-resistant pathogens if they have not grown

    -   e.g., stopping empirical vancomycin in a patient without positive MRSA cultures

-   Biomarkers: C-reactive protein (limited clinical utility), procalcitonin -*areas of diagnostic stewardship as tests are frequently abused*
