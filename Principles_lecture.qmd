...
Prof. Russell Lewis <br> Department of Molecular Medicine <br> University of Padua
...
## Medical history is 80% of diagnosis? {.smaller}
...
Antibiotics should only be started if the differential diagnosis includes likely invasive bacterial infections: <br>**\>90% of upper respiratory tract infections are caused by viruses**
...
-   Without symptoms, a positive culture often represents **colonization or contamination** <br>
...
![](images/outcomes.png){fig-align="center" width="600"}

::: aside
[@luu2021]
:::

# Principle #2: Only use antibiotics when they alter a patient's clinical course of patients {background-color="#9B0014"}
...
::: aside
Antibiotics should be administered immediately in patients with hemodynamic compromise [@kumar2006]
...
![](images/immunocompromise.png){fig-align="center" width="800"}
